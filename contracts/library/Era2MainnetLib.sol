        ...
        publicInputSource = HelperLib.PublicInputDataSource({
            ...
            mdc_column_array_hash_slot: uint8(
                (uint256(
                    ...
                    uint256(
                        bytes32(zkProof[MdcContractSplitStart + SplitStep * 9:MdcContractSplitStart + SplitStep * 10])
                    )
            ),
            mdc_response_makers_hash_slot: uint8(
                (uint256(
                    ...
                    uint256(
                        bytes32(zkProof[MdcContractSplitStart + SplitStep * 11:MdcContractSplitStart + SplitStep * 12])
                    )
            ),
            ...
            manage_source_chain_mainnet_token_info_slot: uint256(
                (uint256(
                    ...
                    uint256(
                        bytes32(zkProof[MdcContractSplitStart + SplitStep * 15:MdcContractSplitStart + SplitStep * 16])
                    )
            ),
            ...
            manage_challenge_user_ratio_slot: uint8(
                (uint256(
                    ...
                    uint256(
                        bytes32(zkProof[MdcContractSplitStart + SplitStep * 19:MdcContractSplitStart + SplitStep * 20])
                    )
            ),
