...
library BytesLib {
    ...
    function contains(bytes memory wholeBytes, bytes memory isExistBytes) internal pure returns (bool) {
        require(wholeBytes.length >= isExistBytes.length, "isExistBytes length not range");
