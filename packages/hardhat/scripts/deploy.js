...
const main = async () => {
  ...
  const Extractor_zk = await deploy("Extractor_zk"); // <-- add in constructor args like line 19 vvvv

  const Extractor_l1 = await deploy("Extractor_l1"); // <-- add in constructor args like line 19 vvvv
